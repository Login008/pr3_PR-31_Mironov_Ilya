// pr3_30.11.2024.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
#include <iostream>
#include <string>
...
public:
    ...
    void pop_front()
    {
        if (head != nullptr)
        {
            ...
            std::cout << "Удалять нечего, список пуст" << std::endl;
    };
    void pop_back()
    {
        if (tail != nullptr)
    ...
    void sort()
    {
        if (head != nullptr)
        {
            ...
            while (current->next != nullptr)
            {
                ...
                {
                    int containing = current->next->data;
            ...
            std::cout << "Нечего сортировать, список пуст" << std::endl;
    };
